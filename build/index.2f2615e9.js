...
let script;
let initialize = ()=>{
    script = require('script:./Level.vue');
    if (script.__esModule) script = script.default;
...
},{"script:./Level.vue":"diXx4","template:./Level.vue":"7Exz1","style:./Level.vue":"lIURU","custom:./Level.vue":"c76x6","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"diXx4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _vue = require("vue");
var _stringSymbolVue = require("./StringSymbol.vue");
var _stringSymbolVueDefault = parcelHelpers.interopDefault(_stringSymbolVue);
...
exports.default = _vue.defineComponent({
        ...
        applyProduction (index) {
            if (this.activeProductionIndex != null) {
                ...
                if (symbol.character == production[0]) {
                    ...
                    for(let i = 0; i < symbolsToInsert.length; i++)this.list.splice(index + i, 0, symbolsToInsert[i]);
                    console.log("After, list is: ", this.list);
                    let newString = this.list.reduce((str, charObj)=>str + charObj.character
                    , "");
    ...
    components: {
        StringSymbol: _stringSymbolVueDefault.default
    }
});

},{"vue":"a2RR7","./StringSymbol.vue":"19qkt","./types":"llBOz","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"19qkt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require('script:./StringSymbol.vue');
    if (script.__esModule) script = script.default;
...
},{"script:./StringSymbol.vue":"4Kjn1","template:./StringSymbol.vue":"KG3he","style:./StringSymbol.vue":"hSWPC","custom:./StringSymbol.vue":"d8pyu","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"4Kjn1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _vue = require("vue");
exports.default = _vue.defineComponent({
...
},{"vue":"a2RR7","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"KG3he":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render
);
...
function render(_ctx, _cache) {
    return _vue.openBlock(), _vue.createElementBlock("span", {
        class: _vue.normalizeClass({
            nonterminalSymbol: _ctx.object.kind == 'Nonterminal',
            activated: (_ctx.productions[_ctx.activeProductionIndex] || [])[0] == _ctx.object.character
        }),
        onClick: _cache[0] || (_cache[0] = (...args)=>_ctx.activate && _ctx.activate(...args)
        )
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"llBOz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "TerminalSymbolObject", ()=>TerminalSymbolObject
);
parcelHelpers.export(exports, "NonterminalSymbolObject", ()=>NonterminalSymbolObject
);
parcelHelpers.export(exports, "stringToSymbols", ()=>stringToSymbols
);
parcelHelpers.export(exports, "formatProductionStrings", ()=>formatProductionStrings
);
class TerminalSymbolObject {
    constructor(character){
        this.character = character.toLowerCase();
        this.kind = "Terminal";
    }
}
class NonterminalSymbolObject {
    constructor(character1){
        this.character = character1.toUpperCase();
...
function formatProductionStrings(pairs) {
    return pairs.map((pair)=>{
        return [
            pair[0],
            stringToSymbols(pair[1])
        ];
    });
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"7Exz1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render
);
...
const _hoisted_3 = {
    id: "targetStringWrapper"
};
const _hoisted_4 = /*#__PURE__*/ _vue.createTextVNode(" Construct: ");
const _hoisted_5 = {
    id: "targetString"
};
const _hoisted_6 = [
...
function render(_ctx, _cache) {
    const _component_string_symbol = _vue.resolveComponent("string-symbol");
    return _vue.openBlock(), _vue.createElementBlock("div", {
        ...
        _vue.createElementVNode("div", _hoisted_1, [
            _vue.createElementVNode("p", _hoisted_2, [
                (_vue.openBlock(true), _vue.createElementBlock(_vue.Fragment, null, _vue.renderList(_ctx.list, (symbol, index)=>{
                    return _vue.openBlock(), _vue.createBlock(_component_string_symbol, {
                        index: index,
                        key: symbol.character + index,
                        activeProductionIndex: _ctx.activeProductionIndex,
                        "onUpdate:activeProductionIndex": _cache[0] || (_cache[0] = ($event)=>_ctx.activeProductionIndex = $event
                        ),
                        productions: _ctx.productions,
                        "onUpdate:productions": _cache[1] || (_cache[1] = ($event)=>_ctx.productions = $event
                        ),
                        onApplyProduction: _ctx.applyProduction
                    }, null, 8 /* PROPS */ , [
                        "index",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"d47Zr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render
);
...
const _hoisted_2 = /*#__PURE__*/ _withScopeId(()=>/*#__PURE__*/ _vue.createElementVNode("div", {
        ...
        /*#__PURE__*/ _vue.createElementVNode("h1", null, "The Formal Grammar Game"),
        /*#__PURE__*/ _vue.createElementVNode("hr")
    ], -1 /* HOISTED */ )
);
const _hoisted_3 = {
    id: "gameWrapper"
